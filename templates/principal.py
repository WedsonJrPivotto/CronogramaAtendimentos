...
class root_principal(ctk.CTk):
  def __init__(self):
    ...
    self.Lbl_ini     = ctk.CTkLabel(master=self.Frm_entrys, text='Hora inicial ',bg_color='#2B2B2B' ,font=('Arial', 20))
    self.Lbl_ini.place(x=340, y=300)
    self.Lbl_fim     = ctk.CTkLabel(master=self.Frm_entrys, text='Hora final  ',bg_color='#2B2B2B' ,font=('Arial', 20))
